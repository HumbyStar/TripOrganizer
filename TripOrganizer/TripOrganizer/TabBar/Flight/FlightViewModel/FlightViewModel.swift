...
class FlightViewModel {
    ...
    var cityName: [FlightModel] = [FlightModel(cityNameObject: "Florianópolis", cityDescriptionObject: "Conhecida por suas praias paradisíacas,                                      Floripa também é famosa por sua culinária e por apresentar uma cultura vibrante.", cityImageObject: "floripa"),
    ...
    var cityDescription: [FlightModel] = [FlightModel(ci)]
